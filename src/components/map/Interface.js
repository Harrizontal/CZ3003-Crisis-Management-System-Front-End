...
import { changeViz } from "../../actions/mapActions";
...
class Interface extends Component {
  ...
  _makeButton(activeState, btnData) {
    ...
    const className =
      activeState === value ? "btn btn-default active" : "btn btn-default";
    ...
    return (
      <div id="ui" style={style.ui}>
        ...
        <div className="container" style={style.legendBox}>
          <div style={style.legendGradient} />
          <div className="row">
            <div
              id="leftTxt"
              className="col-md-6"
